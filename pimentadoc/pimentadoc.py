...
def main():
    ...
    server_argp.add_argument('--address', '-addr', type=arg_check_address, action="store", dest="address", help="Define o endereço e porta do servidor pimentadoc ('mestre').\nEx.: 192.168.1.200:8080.", default="127.0.0.1:8080")
    ...
    client_argp.add_argument('--address', '-addr', type=arg_check_address, action="store", dest="address", help="Define o endereço e porta para conexão com o pimentaserver ('mestre').\nEx.: 192.168.1.200:8080\nEx. IPv6: [4acd:1235::1]:8080.", default="127.0.0.1:8080")
    ...
    if args.exec_mode == 'server':
        ...
        client = pimentaclient.PimentaClient(args.address)
